...
description_block = """Tools to expand Python's enum module.
...
for requires in {'sphinx': ['sphinx', 'sphinx-toolbox>=1.2.0'], 'all': ['sphinx', 'sphinx-toolbox>=1.2.0']}.values():
...
source:
  url: "https://pypi.io/packages/source/e/enum_tools/enum_tools-{__version__}.tar.gz"
...
about:
  ...
  doc_url: https://enum_tools.readthedocs.io
  dev_url: https://github.com/domdfcoding/enum_tools
